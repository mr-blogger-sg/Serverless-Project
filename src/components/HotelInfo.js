...
const HotelInfo = () => {
  ...
  const loadAccessibilityData = async() => {
    ...
    const resp = await fetch('https://ntzgneo6sd.execute-api.us-east-1.amazonaws.com/Production/accessibilities');
  ...
  const loadServicesData = async() => {
    // Query the API Gateway
    const resp = await fetch('https://ntzgneo6sd.execute-api.us-east-1.amazonaws.com/Production/services');
    let jsonData = await resp.json();
